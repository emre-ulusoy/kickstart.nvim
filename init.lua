...
require('lazy').setup({
  ...
  -- 'nvim-treesitter/nvim-treesitter-textobjects', -- TODO: might wanna use this later on
    ...
    config = function()
      ...
      vim.api.nvim_create_autocmd('LspAttach', {
        ...
        callback = function(event)
          ...
          -- INFO: Actually <C-t> is for terminal, use <C-o> for jumpstack back, and sometime look at what the difference is.
          vim.keymap.set('n', 'grd', builtin.lsp_definitions, { buffer = buf, desc = '[G]oto [D]efinition' })
          -- For now repeat the command in its previous binding
  ...
  { -- Autocompletion
    ...
    opts = {
      keymap = {
        ...
        -- Overwriting the defaults I don't like
        ['<C-y>'] = false,
